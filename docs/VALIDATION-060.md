> Historical validation for fde83cf / collector 0.6.0, not the 0.7.0 working tree.
...
## Subsequent historical CI result

GitHub reports [run 36157647289](https://github.com/erdosl/windows-network-diagnostics/actions/runs/36157647289)
as completed successfully for exact revision `fde83cf07aa4fc568919272393a7d256d49b122a`,
created 2026-09-25T15:57:38Z. The workflow used the Windows Server `windows-2022`
runner and Windows PowerShell. This is historical CI for 0.6.0, not validation
of 0.7.0 and not Windows 10/11 native-provider validation. The exact runner OS
build was not re-read from its archived artifact in this task.
